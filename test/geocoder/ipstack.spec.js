  ...
  describe('forward', () => {
    it('should call api', async function () {
      ...
      sinon.assert.calledOnceWithExactly(
        mockedAdapter,
        'http://api.ipstack.com/66.249.64.0?access_key=apiKey'
      )
    })
    ...
    it('should return address for ipv6', async function () {
      ...
      const expUrl =
        'http://api.ipstack.com/2001:e61:3add:9602:7d42:8734:e471:94fb?access_key=apiKey'
  ...
  describe('reverse', () => {
    it('should throw', async function () {
      ...
      try {
        ...
        assert.strictEqual(
          e.message,
          'IpStackGeocoder does not support reverse geocoding'
        )
      }
    })
  })
