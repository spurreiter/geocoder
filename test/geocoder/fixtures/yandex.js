const m = {
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'TR',
                      formatted:
                        'Turkey, İstanbul, Fatih, Cankurtaran Mah., Kabasakal Cad.',
                      Components: [
                        {
                          kind: 'country',
                          name: 'Turkey'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'GB',
                      formatted:
                        'United Kingdom, England, Worcestershire County, Birmingham',
                      Components: [
                        {
                          kind: 'country',
                          name: 'United Kingdom'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'GB',
                      formatted:
                        'United Kingdom, England, Worcestershire County, Worcester and Birmingham Canal',
                      Components: [
                        {
                          kind: 'country',
                          name: 'United Kingdom'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'GB',
                      formatted:
                        'United Kingdom, England, Worcestershire County, Birmingham Road',
                      Components: [
                        {
                          kind: 'country',
                          name: 'United Kingdom'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'GB',
                      formatted:
                        'United Kingdom, England, Warwickshire County, Birmingham Road',
                      Components: [
                        {
                          kind: 'country',
                          name: 'United Kingdom'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'US',
                      formatted:
                        'United States of America, New York, Bedford Avenue',
                      Components: [
                        {
                          kind: 'country',
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      country_code: 'US',
                      formatted:
                        'United States of America, New York, Brooklyn Borough',
                      Components: [
                        {
                          kind: 'country',
                          name: 'United States of America'
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    AddressDetails: {
                      Country: {
                        AddressLine:
                          'United States of America, New York, Suffolk',
                        CountryNameCode: 'US',
                        CountryName: 'United States of America',
                        AdministrativeArea: {
                          AdministrativeAreaName: 'New York',
  ...
  reverse: {
    formattedAddress:
      'Соединённые Штаты Америки, штат Нью-Йорк, боро Бруклин, авеню Бедфорд',
    latitude: 40.653641,
    longitude: -73.956123,
