                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        { kind: 'country', name: 'Turkey' },
                        { kind: 'province', name: 'İstanbul' },
                        { kind: 'area', name: 'Fatih' },
                        { kind: 'district', name: 'Cankurtaran Mah.' },
                        { kind: 'street', name: 'Kabasakal Cad.' }
                      ]
                    },
                    AddressDetails: {
                      Country: {
                          ...
                          SubAdministrativeArea: {
                            ...
                            Locality: {
                              DependentLocality: {
                                ...
                                Thoroughfare: { ThoroughfareName: 'Kabasakal Cad.' }
                              }
                            }
                          }
                        }
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        { kind: 'country', name: 'United Kingdom' },
                        { kind: 'province', name: 'England' },
                        { kind: 'area', name: 'Worcestershire County' },
                        { kind: 'locality', name: 'Birmingham' }
                      ]
                    },
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          ...
                          SubAdministrativeArea: {
                            ...
                            Locality: { LocalityName: 'Birmingham' }
                          }
                        }
                      }
                    }
                  ...
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        ...
                        { kind: 'province', name: 'England' },
                        { kind: 'area', name: 'Worcestershire County' },
                        { kind: 'street', name: 'Birmingham Road' }
                      ]
                    },
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          ...
                          SubAdministrativeArea: {
                            SubAdministrativeAreaName: 'Worcestershire County',
                            Locality: {
                              Thoroughfare: { ThoroughfareName: 'Birmingham Road' }
                            }
                          }
                        }
                      }
                  ...
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        { kind: 'country', name: 'United Kingdom' },
                        { kind: 'province', name: 'England' },
                        { kind: 'area', name: 'Warwickshire County' },
                        { kind: 'street', name: 'Birmingham Road' }
                      ]
                    },
                    AddressDetails: {
    ...
    expResults: [
      {
        ...
        streetNumber: undefined,
        extra: { bbox: [-2.034298, 52.371578, -1.863896, 52.412181] }
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-2.223771, 52.182078, -1.986696, 52.332743] }
      },
      {
        ...
        streetNumber: undefined,
        extra: { bbox: [-2.238314, 52.390989, -2.157214, 52.411511] }
      },
      {
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-1.687683, 52.42818, -1.57931, 52.446166] }
      },
      {
        formattedAddress: 'United Kingdom, England, Worcestershire County, Birmingham Road',
        latitude: 52.390373,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-2.045841, 52.378616, -2.007429, 52.395891] }
      },
      {
        formattedAddress: 'United Kingdom, England, Worcestershire County, Birmingham Road',
        latitude: 52.291802,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-1.895167, 52.274701, -1.873257, 52.309199] }
      },
      {
        formattedAddress: 'United Kingdom, England, Worcestershire County, Birmingham Road',
        latitude: 52.359552,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-2.048294, 52.34668, -2.04523, 52.372606] }
      },
      {
        formattedAddress: 'United Kingdom, England, Warwickshire County, Birmingham Road',
        latitude: 52.234545,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-1.745687, 52.223601, -1.733093, 52.245298] }
      },
      {
        formattedAddress: 'United Kingdom, England, Warwickshire County, Birmingham Road',
        latitude: 52.204149,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-1.727191, 52.194821, -1.709054, 52.215799] }
      },
      {
        formattedAddress: 'United Kingdom, England, Warwickshire County, Birmingham Road',
        latitude: 52.303005,
        ...
        streetName: 'Birmingham Road',
        streetNumber: undefined,
        extra: { bbox: [-1.691088, 52.285952, -1.595471, 52.351301] }
      }
    ]
  },
  '40.714232,-73.9612889': {
                  ...
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        ...
                        { kind: 'province', name: 'New York' },
                        { kind: 'locality', name: 'New York' },
                        { kind: 'street', name: 'Bedford Avenue' }
                      ]
                    },
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          ...
                          Locality: {
                            ...
                            Thoroughfare: { ThoroughfareName: 'Bedford Avenue' }
                          }
                        }
                      }
                    }
                  ...
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [
                        ...
                        { kind: 'province', name: 'New York' },
                        { kind: 'locality', name: 'New York' },
                        { kind: 'district', name: 'Brooklyn Borough' }
                      ]
                    },
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          ...
                          Locality: {
                            LocalityName: 'New York',
                            DependentLocality: { DependentLocalityName: 'Brooklyn Borough' }
                          }
                        }
                      }
                    }
                  ...
                  GeocoderMetaData: {
                    ...
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          AdministrativeAreaName: 'New York',
                          Locality: { LocalityName: 'New York' }
                        }
                      }
                    }
                  }
                  ...
                  GeocoderMetaData: {
                    ...
                    AddressDetails: {
                      Country: {
                        ...
                        AdministrativeArea: {
                          AdministrativeAreaName: 'New York',
                          Locality: { Premise: { PremiseName: 'Suffolk' } }
                        }
                      }
                    }
                  }
                  ...
                  GeocoderMetaData: {
                    ...
                    AddressDetails: {
                      Country: {
                        ...
                        CountryNameCode: 'US',
                        CountryName: 'United States of America',
                        AdministrativeArea: { AdministrativeAreaName: 'New York' }
                      }
                    }
                  }
                },
                ...
                metaDataProperty: {
                  GeocoderMetaData: {
                    ...
                    Address: {
                      ...
                      Components: [{ kind: 'hydro', name: 'Atlantic Ocean' }]
                    },
                    AddressDetails: {
                      Country: {
    ...
    expResults: [
      ...
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-74.05589, 40.569203, -73.83716, 40.739386] }
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-74.260464, 40.495247, -73.700643, 40.917998] }
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-74.042191, 40.545997, -71.856195, 41.203869] }
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-79.762591, 40.431767, -71.606517, 45.0162] }
      },
      {
        ...
        streetName: undefined,
        streetNumber: undefined,
        extra: { bbox: [-193.546088, 16.530522, -66.910214, 71.49891] }
      },
      {
