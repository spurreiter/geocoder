const m = {
  '135 pilkington avenue, birmingham': {
    body: {
      ...
      candidates: [
        {
          address:
            '135 Pilkington Avenue, Wylde Green, Sutton Coldfield, West Midlands, England, B72 1LH',
          location: {
            x: -1.8160966054189729,
            y: 52.54869661680167
          },
          score: 97.45,
          attributes: {
            LongLabel:
              '135 Pilkington Avenue, Wylde Green, Sutton Coldfield, West Midlands, England, B72 1LH, GBR',
        ...
        {
          address:
            '135 Packington Avenue, Birmingham, West Midlands, England, B34 7',
          location: {
            x: -1.7725176463579642,
            y: 52.493721559682136
          },
          score: 94.03,
          attributes: {
            LongLabel:
              '135 Packington Avenue, Birmingham, West Midlands, England, B34 7, GBR',
            Addr_type: 'StreetAddress',
            Type: '',
            PlaceName: '',
            Place_addr:
        ...
        {
          address:
            'Packington Avenue, Birmingham, West Midlands, England, B34 7',
          location: {
            x: -1.7718263463743127,
            y: 52.494327588929764
          },
          score: 86.59,
          attributes: {
            LongLabel:
              'Packington Avenue, Birmingham, West Midlands, England, B34 7, GBR',
    ...
    expResults: [
      {
        ...
        extra: {
          ...
          rank: 20,
          bbox: [
            -1.8170966054189728, 52.54769661680167, -1.815096605418973,
            52.54969661680167
          ]
        }
      },
      {
        ...
        extra: {
          ...
          rank: 20,
          bbox: [
            -1.773517646357964, 52.49272155968214, -1.7715176463579643,
            52.494721559682134
          ]
        }
      },
      {
        ...
        extra: {
          ...
          rank: 20,
          bbox: [
            -1.7728263463743126, 52.493327588929766, -1.7708263463743128,
            52.49532758892976
          ]
        }
      }
  ...
  '40.714232,-73.9612889': {
    body: {
      address: {
        ...
        LongLabel:
          'Chocolat Michel Cluizel, 279 Bedford Ave, Brooklyn, NY, 11211, USA',
  ...
  forward: {
    formattedAddress:
      '1 Arcades des Champs Elysées, 75008, 8e Arrondissement, Paris, Île-de-France, FRA',
    latitude: 48.871732986938,
    longitude: 2.304529008597,
    country: 'France',
    countryCode: 'FR',
    state: 'Île-de-France',
    city: 'Paris',
    ...
    extra: {
      ...
      rank: 20,
      bbox: [2.303529008597, 48.870732986938, 2.305529008597, 48.872732986938]
    }
  },
  reverse: {
    formattedAddress:
