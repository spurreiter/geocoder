const m = {
  '135 pilkington avenue, birmingham': {
    ...
    body: {
      items: [
        ...
        },
        {
          ...
          address: {
            label:
              '135 Pilkington Ave, Santa Cruz, CA 95062-3737, United States',
            countryCode: 'USA',
            countryName: 'United States',
            stateCode: 'CA',
            state: 'California',
    ...
    expResults: [
      {
        formattedAddress:
          '135 Avenue Y, Birmingham, AL 35214-5103, United States',
        latitude: 33.53583,
        longitude: -86.87725,
      ...
      {
        formattedAddress:
          '135 Avenue U, Birmingham, AL 35214-5021, United States',
        latitude: 33.53568,
        longitude: -86.88066,
        country: 'United States',
        countryCode: 'US',
  ...
  '40.714232,-73.9612889': {
    ...
    expResults: [
      {
        formattedAddress:
          '277 Bedford Ave, Brooklyn, NY 11211-4203, United States',
        latitude: 40.71423,
        longitude: -73.96128,
        country: 'United States',
        countryCode: 'US',
