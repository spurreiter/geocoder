export const fixtures = {
  '135 pilkington avenue, birmingham': {
      ...
      results: [
        {
          address_components: [
            ...
            {
              long_name: 'Pilkington Avenue',
              short_name: 'Pilkington Ave',
              types: ['route']
            },
            {
              long_name: 'Sutton Coldfield',
              short_name: 'Sutton Coldfield',
              types: ['postal_town']
            },
            {
          ...
          formatted_address: '135 Pilkington Ave, Sutton Coldfield B72 1LH, UK',
          geometry: {
            location: { lat: 52.5488156, lng: -1.8162539 },
            location_type: 'RANGE_INTERPOLATED',
            viewport: {
              northeast: { lat: 52.55016458029149, lng: -1.814904919708498 },
              southwest: { lat: 52.5474666197085, lng: -1.817602880291502 }
            }
          },
          place_id: 'EjAxMzUgUGlsa2luZ3RvbiBBdmUsIFN1dHRvbiBDb2xkZmllbGQgQjcyIDFMSCwgVUsiGxIZChQKEgmHebGMEaVwSBHy8dD53roDUhCHAQ',
    ...
    expResults: [
      {
        formattedAddress: '135 Pilkington Ave, Sutton Coldfield B72 1LH, UK',
        latitude: 52.5488156,
        longitude: -1.8162539,
    ...
    body: {
      ...
      results: [
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 40.7142628, lng: -73.9612131 },
              southwest: { lat: 40.7141534, lng: -73.9613792 }
            },
            location: { lat: 40.7142015, lng: -73.96130769999999 },
            location_type: 'ROOFTOP',
            viewport: {
              northeast: { lat: 40.7155570802915, lng: -73.95994716970849 },
              southwest: { lat: 40.7128591197085, lng: -73.96264513029149 }
            }
          },
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 40.7145065, lng: -73.9612923 },
              southwest: { lat: 40.7139055, lng: -73.96168349999999 }
            },
            location: { lat: 40.7142045, lng: -73.9614845 },
            location_type: 'GEOMETRIC_CENTER',
            viewport: {
              northeast: { lat: 40.7155549802915, lng: -73.96013891970848 },
              southwest: { lat: 40.7128570197085, lng: -73.96283688029149 }
            }
          },
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 40.7167119, lng: -73.9420904 },
              southwest: { lat: 40.6984866, lng: -73.9699432 }
            },
            location: { lat: 40.7043921, lng: -73.9565551 },
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 40.7251773, lng: -73.936498 },
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 40.739446, lng: -73.8333651 },
        ...
        },
        {
          ...
          geometry: {
            bounds: {
              northeast: { lat: 41.1612401, lng: -71.85620109999999 },
              southwest: { lat: 40.5429789, lng: -74.0419497 }
            },
            location: { lat: 40.789142, lng: -73.13496099999999 },
            location_type: 'APPROXIMATE',
            viewport: {
              northeast: { lat: 41.1612401, lng: -71.85620109999999 },
              southwest: { lat: 40.5429789, lng: -74.0419497 }
        ...
        },
        {
          ...
          formatted_address: 'P27Q+MF New York, NY, USA',
          geometry: {
            bounds: {
              northeast: { lat: 40.71425, lng: -73.96124999999999 },
              southwest: { lat: 40.714125, lng: -73.96137499999999 }
            },
            location: { lat: 40.714232, lng: -73.9612889 },
            location_type: 'ROOFTOP',
            viewport: {
              northeast: { lat: 40.71553648029149, lng: -73.95996351970848 },
              southwest: { lat: 40.71283851970849, lng: -73.9626614802915 }
            }
          },
          place_id: 'GhIJ2uBE9GtbREARgODgwYV9UsA',
          plus_code: {
            compound_code: 'P27Q+MF New York, NY, USA',
            global_code: '87G8P27Q+MF'
          },
    ...
    expResults: [
      ...
      },
      {
        ...
        extra: {
          ...
          sublocality: 'Brooklyn',
          sublocalityLevel1: 'Brooklyn',
          postalCodeSuffix: '4203',
          confidence: 1
        }
      },
      {
        formattedAddress: '291-275 Bedford Ave, Brooklyn, NY 11211, USA',
        latitude: 40.7142045,
        longitude: -73.9614845,
        country: 'United States',
        countryCode: 'US',
        state: 'New York',
        region: 'Kings County',
      ...
      {
        formattedAddress: 'South Williamsburg, Brooklyn, NY, USA',
        latitude: 40.7043921,
      ...
      {
        formattedAddress: 'Brooklyn, NY 11211, USA',
        latitude: 40.7093358,
        longitude: -73.9565551,
        country: 'United States',
        countryCode: 'US',
      ...
      {
        formattedAddress: 'Williamsburg, Brooklyn, NY, USA',
        latitude: 40.7081156,
      ...
      {
        formattedAddress: 'Kings County, Brooklyn, NY, USA',
        latitude: 40.6528762,
      ...
      {
        formattedAddress: 'Long Island, New York, USA',
        latitude: 40.789142,
        ...
        streetNumber: undefined,
        extra: {
          establishment: 'Long Island',
          naturalFeature: 'Long Island',
          confidence: 0.5
        }
      },
      {
      ...
      {
        formattedAddress: 'P27Q+MF New York, NY, USA',
        latitude: 40.714232,
