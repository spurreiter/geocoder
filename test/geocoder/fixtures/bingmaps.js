const m = {
  '135 pilkington avenue, birmingham': {
    body: {
          ...
          resources: [
            {
              ...
              bbox: [
                52.54493408242932, -1.8248599349505783, 52.552659517570675,
                -1.8079220650494219
              ],
              ...
              address: {
                ...
                formattedAddress:
                  '135 Pilkington Avenue, Sutton Vesey, Sutton Coldfield, Birmingham B72 1LH, England, United Kingdom',
                locality: 'Birmingham',
                postalCode: 'B72 1LH',
      ...
      traceId:
        '0b9fa14a3d1542a29f9e94101b638c87|DU00000D72|0.0.0.1|Ref A: 96877241EA364F968BB71CFFC57CFC3D Ref B: DB3EDGE1110 Ref C: 2021-05-25T19:10:50Z'
    },
    expResults: [
      {
        formattedAddress:
  ...
  '40.714232,-73.9612889': {
    body: {
          ...
          resources: [
            {
              __type:
                'Location:http:\u002F\u002Fschemas.microsoft.com\u002Fsearch\u002Flocal\u002Fws\u002Frest\u002Fv1',
              bbox: [
                40.710324282429326, -73.96805742719883, 40.71804971757068,
                -73.95446857280118
              ],
              ...
              address: {
                ...
                formattedAddress:
                  '279 Bedford Ave, Brooklyn, NY 11211, United States',
                intersection: {
      ...
      statusDescription: 'OK',
      traceId:
        'dcb79762819b4ec88bf0223a37146078|DU00000D57|0.0.0.1|DU01EAP000003EB'
    },
    expResults: [
      {
