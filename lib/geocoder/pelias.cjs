...
class PeliasGeocoder extends abstract.AbstractGeocoder {
  /**
   * available options
  ...
  _formatResult(result = {}) {
    ...
    const confidence =
      properties.confidence < 1 ? toFixed.toFixed(properties.confidence - 0.1) : 1;
    ...
    const formatted = {
      ...
      countryCode: isocode.countryCode(properties.country_a),
