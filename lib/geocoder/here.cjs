...
class HereGeocoder extends abstract.AbstractGeocoder {
  /**
   * available options
  ...
  _formatResult(result) {
    ...
    const formatted = {
      ...
      countryCode: isocode.countryCode(address.countryCode),
      state: address.state,
      ...
      extra: {
        id,
        confidence: toFixed.toFixed(scoring.queryScore || 0)
      }
    };
...
exports.HereGeocoder = HereGeocoder;
