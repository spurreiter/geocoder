...
var camelCase = require('../utils/camelCase.cjs');
 ...
 */
class GeoLite2Geocoder extends abstract.AbstractGeocoder {
  /**
   * available options
  ...
  _formatResult(language, result = {}) {
    const {
      ...
      traits = {},
      location = {}
    } = camelCase.objToCamelCase(result);
...
exports.GeoLite2Geocoder = GeoLite2Geocoder;
